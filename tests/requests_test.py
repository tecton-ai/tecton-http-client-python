...
class TestRequests:
    ...
    default_get_feature_request_data = GetFeaturesRequestData(join_key_map={"test_key": "test_value"})
    ...
    def test_none_join_value(self) -> None:
        get_feature_request_data = GetFeaturesRequestData(join_key_map={"test_key": None})
    ...
    def test_mixed_type_join_key_value(self) -> None:
        get_feature_request_data = GetFeaturesRequestData(
    ...
    def test_join_key_and_request_context(self) -> None:
        ...
        get_feature_request_data = GetFeaturesRequestData(join_key_map, request_context_map)
    ...
    def test_simple_request_with_none_join_key(self) -> None:
        local_get_feature_request_data = GetFeaturesRequestData(
