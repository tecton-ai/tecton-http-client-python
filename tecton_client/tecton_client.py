    ...
    def get_features(self, request: GetFeaturesRequest) -> GetFeaturesResponse:
        ...
        Raises:
            BadRequestError: If the response returned from the Tecton Server is 400 Bad Request. The error could be
                ...
                3. Unexpected JSON type for a key in the joinKeyMap passed in the :class:`GetFeaturesRequestData` object
                4. Unknown join key passed in the :class:`GetFeaturesRequestData` object in the request
            UnauthorizedError: If the response returned from the Tecton Server is 401 Unauthorized, it could be caused
                by the following reasons:
                1. Tecton does not recognize the API Key in your request. Please refer to the [API Key Documentation]
            ...
            ForbiddenError: If the response returned from the Tecton Server is 403 Forbidden, it could be because:
                1. The Service Account associated with your API Key does not have the necessary permissions to query
                    the feature service. Please refer to the
            ...
            ServiceUnavailableError: If the response returned from the Tecton Server is 503 Service Unavailable, it
                could be because Tecton is currently unable to process your request because either the Online Store is
