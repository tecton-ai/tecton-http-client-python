...
class TectonClientException(TectonException):
    """
     Class that declares a TectonClientException, exceptions thrown by the client
    """


class TectonServerException(TectonException):
    """
     Class that declares a TectonServerException, exceptions thrown by the server
    """
